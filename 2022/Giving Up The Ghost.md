...
- A brilliant web editor that stays out of your way and let's you call content blocks as you need them.
...
The problem with self-hosting is that it can get fairly complex. Most of the new features that get rolled out require some sort of manual intervention in order to make them work with a self-hosted instance. Setting up the email newsletter functionality with Mailgun is pretty difficult. I tried and failed a couple of times to do it before I got it right, thanks to a [good set of instructions](https://www.kevindstevens.com/setting-up-a-ghost-site-with-newsletter/) and the [JSONLint tool](https://jsonlint.com/). Once you get it going, it's pretty solid, though. Except that you're dealing with Mailgun. 
...
So, for now at least, I've closed up shop on my Ghost blog. Knowing my penchant for playing around with blogging platforms, email tools, read-it-later services, etc., I can't say that I won't ever go back. I'm trying to scale back my web presence to make it easier to reliably follow what I'm putting out, though. 
